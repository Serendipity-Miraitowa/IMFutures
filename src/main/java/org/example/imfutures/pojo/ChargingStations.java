...
public class ChargingStations {
    ...
    public ChargingStations(Integer id, String name, String type, double price, double distance, String address, String brief, String parking, String parkingPrice, Time jobStartTime, Time jobENdTime, String phone, String img, String discount, String company) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.price = price;
