...
public class Order {
    ...
    public Order(Integer id, Integer userId, Date date, String time, Integer chargingPiesId, Integer chargingStationsId, Integer status, String serialNo, Integer commentId, int useStatus, int payStatus) {
        this.id = id;
        this.userId = userId;
        this.date = date;
        this.time = time;
